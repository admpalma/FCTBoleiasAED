...
/**
 * An {@link AbstractIteratorWrapper} is intended to be used when it is
 * preferable to change the return type of {@link Iterator#next()} during
 * iteration rather than during constrution
 * 
